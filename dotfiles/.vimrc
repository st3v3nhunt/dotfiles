...
set completeopt=menu,menuone,popup,noselect,noinsert " fixes issue with automatically completing autocomplete options (noinsert) and switches to popup rather than preview window
